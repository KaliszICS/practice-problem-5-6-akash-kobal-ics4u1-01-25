public class Smartphone {
    ...
    public Smartphone(String brand, String model, int batteryCapacity, double displaySize, String resolution,
    ...
    public String toString() {
        return "[" + brand + "] [" + model + "]" + "Smartphone" + "[" + battery.toString() + "]" + "[" + display.toString() + "]" + "[" + processor.toString() + "]";
    }
}
